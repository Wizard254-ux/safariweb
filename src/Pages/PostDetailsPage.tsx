              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-gray-700">
                    Amazing content! I loved reading about the wildlife in Masai Mara. The photos are breathtaking.
                  </p>
                  <button className="mt-2 text-sm text-green-600 hover:text-green-700">Reply</button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-gray-700">
                    This article brought back so many memories from my trip last year. Can't wait to visit Kenya again!
                  </p>
                  <button className="mt-2 text-sm text-green-600 hover:text-green-700">Reply</button>
                </div>
              </div>
